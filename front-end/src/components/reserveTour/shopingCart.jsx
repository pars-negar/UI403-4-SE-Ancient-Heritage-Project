  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: "1px 5px 10px #585858",
      }}
    >
      <h2
        className="!text-2xl font-bold border-r-4 border-blue-700 pr-2 mb-4"
        style={{ fontFamily: "vazirmatn", fontWeight: 600 }}
      >
        سبد خرید
      </h2>
      <div
        className="text-sm text-gray-800 leading-7 mb-4 whitespace-pre-line"
      ...
      <hr className="my-4" />
      <div
        className="flex justify-between items-center text-lg font-medium mb-6"
        style={{ fontFamily: "vazirmatn", fontWeight: 500 }}
      >
        <span>مجموع</span>
        <span>
